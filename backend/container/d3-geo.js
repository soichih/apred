...
function albersUsa() {
  var cache,
      ...
      puertoRico = conicEqualArea().rotate([66, 0]).center([0, 18]).parallels([8, 18]), puertoRicoPoint,
  ...
  albersUsa.translate = function(_) {
    ...
    puertoRicoPoint = puertoRico
        ...
        .clipExtent([[x + 0.320 * k + epsilon, y + 0.204 * k + epsilon], [x + 0.380 * k - epsilon, y + 0.234 * k - epsilon]])
        .stream(pointStream);
