...
const counties_geo_json = fs.readFileSync(__dirname+'/../../../raw/counties_geo.json');
const counties_geo = JSON.parse(counties_geo_json);
console.log("loaded counties:", counties_geo.features.length);

const cb_geo_json = fs.readFileSync(__dirname+'/../../../raw/cb_2018_us_aiannh_500k-export.geojson');
...
console.log("saving");
fs.writeFileSync(__dirname+"/../../../data/tribes.json", JSON.stringify(tribes));
